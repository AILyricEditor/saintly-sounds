import { isOnPage } from "../../tools/tools"; // Import the useIsOnPage function
...
const links = [
	...
	{ 
		...
		active: () => isOnPage('/music-dashboard'),	 
		activePattern: /^\/music-dashboard$/,
		label: 'Shop',
	...
	{ 
		href: '/music',
		active: () => isOnPage('/music') || isOnPage('/song'),
		activePattern: /^\/(music|song)(\/.*)?$/,
		label: 'Music',
		...
		sublinks: [
			...
			{ 
				href: '/music/albums', 
				label: 'Albums', 
				active: () => isOnPage('/music/albums'),
				activePattern: /^\/music\/albums$/,
			},
			{ 
				href: '/music/singles', 
				label: 'Singles', 
				active: () => isOnPage('/music/singles'),
				activePattern: /^\/music\/singles$/,
			},
		]
	},
	{ href: ' ',
